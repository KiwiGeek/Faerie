...
/// system font family). This keeps font files &mdash; and their licences &mdash; out of the library/NuGet.
///
...
///       <c>"avares://MyGame/Assets/Fonts"</c> &mdash; the family name is read from the font's name table.</item>
/// </list>
